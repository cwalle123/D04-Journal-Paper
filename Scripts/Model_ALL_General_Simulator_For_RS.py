...
#Internal imports
from Model_ALL_RandomSampling import generate_random_sampling_data, generate_siddharth_width
...
def generate_rs(sensor, n_steps, target_dist, params):
    # RS version ignores target_dist and params at generation stage
    return generate_random_sampling_data(sensor, steps=n_steps, tows=1)[0]
...
LT = generate_rs("LT", LT_steps, None, params["LT"])
CAM = generate_rs("CAM", CAM_steps, None, params["CAM"])
LLSB = generate_rs("LLS_B", LLSB_steps, None, params["LLSB"])
LLSA = generate_rs("LLS_A", LLSA_steps, None, params["LLSA"])
